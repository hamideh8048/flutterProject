...
int currentIndex=0;
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> firstSize = <String>["33", "34", "35","36","37","38","39"];
    final List<String> secondSize = <String>["40", "41", "42","43","44","45","46"];
        ...
        mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                      ...
                      children: [
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding:
                                const EdgeInsets.only(left: 65,right: 68),
                                child:
                                Text(
                                  "9.5",
                                  style: const TextStyle(
              ...
              // ,Padding(
              //   padding:  EdgeInsets.fromLTRB(28, MediaQuery.of(context).size.width*.8,24,0),
              //   child:
,
            ],
